...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-bg flex items-center justify-center p-4 relative overflow-hidden">
      {/* Ambient blobs */}
      <div className="fixed top-0 left-0 h-[420px] w-[420px] rounded-full pointer-events-none"
        style={{ background: 'radial-gradient(circle, rgba(108,65,210,0.18) 0%, transparent 70%)', transform: 'translate(-30%,-30%)' }} />
      <div className="fixed bottom-0 right-0 h-[350px] w-[350px] rounded-full pointer-events-none"
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            >F</div>
            <h1 className="text-2xl font-black text-text-primary tracking-tight mb-1.5">Create Account</h1>
          ...
          <p className="mt-7 text-center text-sm text-text-secondary">
            ...
            <Link to="/login" className="text-purple-400 font-bold hover:text-purple-300 transition-colors">Sign in</Link>
          </p>
        </div>
