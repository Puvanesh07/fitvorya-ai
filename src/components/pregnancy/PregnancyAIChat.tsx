...
function formatMessage(text: string): React.ReactNode {
  // Convert **bold**, bullet points, and newlines to JSX
        ...
        <div className="flex flex-wrap gap-2">
          {QUICK_QUESTIONS.map(q => (
            <button
              ...
              disabled={loading}
              className="px-3 py-1.5 bg-surface2 border border-border rounded-full text-xs font-medium text-text-secondary hover:border-purple-400 hover:text-purple-600 dark:hover:text-purple-400 transition-all disabled:opacity-40"
            >
              {q}
            </button>
          ))}
